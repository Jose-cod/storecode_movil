...
public class ProductPresenter {
    ...
    public MutableLiveData<List<RespGetProductByUser>> listProducts = new MutableLiveData();
    ...
    public MutableLiveData<Boolean> isLoadingAll= new MutableLiveData<Boolean>();
    ...
    public void getProductsByUser(String id){
        ...
        Call<List<RespGetProductByUser>> call =restClientService.cargarProductos(id);
        //log.info("REQUEST:" + reqLoginDto.toString());
